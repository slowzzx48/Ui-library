...
function UI:CreateWindow(Config)
    ...
    if Window.KeySystem and Window.KeySystem.KeyValidator then
        ...
        local KeyTitle = KeyConfig.Title or "Welcome to Void Hub X"
        ...
        local Providers = KeyConfig.Providers or {
            { Name = "LootLabs", URL = KeyConfig.URL or "", Color = Color3.fromRGB(140, 80, 255) },
            { Name = "Linkvertise", URL = KeyConfig.URL or "", Color = Color3.fromRGB(255, 140, 40) },
            { Name = "Work.ink", URL = KeyConfig.URL or "", Color = Color3.fromRGB(0, 200, 140) },
        }
        ...
        local KeyFrame = VoidUI:Create("Frame", {
            ...
            VoidUI:Create("UICorner", { CornerRadius = UDim.new(0, 18) }),
        ...
        PasteBtn.MouseButton1Click:Connect(function()
            ...
            if ok and clip and #clip > 0 then
                KeyBox.Text = tostring(clip):gsub("%s+", "")
            end
        end)
        ...
        local DiscordBtn = VoidUI:Create("TextButton", {
            ...
            FontFace = Font.new([[rbxassetid://12187365364]], Enum.FontWeight.Medium),
            TextSize = 13,
            TextColor3 = Color3.fromRGB(120, 140, 255),
            AutoButtonColor = false,
            ZIndex = 202,
        })
        ...
        SubmitBtn.MouseButton1Click:Connect(function()
            ...
            if valid then
                ...
                SubmitBtn.BackgroundColor3 = Color3.fromRGB(30, 80, 40)
                task.wait(0.6)
                KeyFrame:Destroy()
...
local Window = VoidUI:CreateWindow({
    ...
    KeySystem = {
        ...
        Providers = {
            { Name = "LootLabs", URL = "https://lootlabs.gg/...", Color = Color3.fromRGB(140, 80, 255) },
            { Name = "Linkvertise", URL = "https://linkvertise.com/...", Color = Color3.fromRGB(255, 140, 40) },
            { Name = "Work.ink", URL = "https://work.ink/...", Color = Color3.fromRGB(0, 200, 140) },
        },
    },
})
