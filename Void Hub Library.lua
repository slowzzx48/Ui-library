...
function UI:CreateWindow(Config)
    ...
    if Window.KeySystem and Window.KeySystem.KeyValidator then
        ...
        local DiscordBtn = VoidUI:Create("TextButton", {
            ...
            FontFace = Font.new([[rbxassetid://12187365364]], Enum.FontWeight.Medium),
            TextSize = 12,
            TextColor3 = Color3.fromRGB(130, 150, 255),
            AutoButtonColor = false,
            ZIndex = 202,
        })
        ...
        SubmitBtn.MouseButton1Click:Connect(function()
            ...
            if valid then
                ...
                SubmitBtn.BackgroundColor3 = Color3.fromRGB(25, 70, 35)
                KeyBoxStroke.Color = Color3.fromRGB(40, 140, 60)
                task.wait(0.55)
                KeyFrame:Destroy()
                coroutine.resume(thread)
            else
                SubmitBtn.Text = "Invalid Key"
                SubmitBtn.BackgroundColor3 = Color3.fromRGB(70, 25, 25)
